...
------------- | ------------- | -------------
[**get_customer**](CommonApi.md#get_customer) | **GET** /common/customer | Get Customer
[**get_customer_detail**](CommonApi.md#get_customer_detail) | **GET** /common/customer/detail | Get Customer Detail
[**get_outages**](CommonApi.md#get_outages) | **GET** /discovery/outages | Get Outages
[**get_status**](CommonApi.md#get_status) | **GET** /discovery/status | Get Status
...
try:
    ...
    print("Exception when calling CommonApi->get_customer: %s\n" % e)
```
...
try:
    ...
    print("Exception when calling CommonApi->get_customer_detail: %s\n" % e)
```
...
# **get_outages**
> ResponseDiscoveryOutagesList get_outages(x_v, x_min_v=x_min_v)
...
try:
    # Get Outages
    api_response = api_instance.get_outages(x_v, x_min_v=x_min_v)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CommonApi->get_outages: %s\n" % e)
```
...
# **get_status**
> ResponseCommonDiscoveryStatus get_status(x_v, x_min_v=x_min_v)
...
try:
    # Get Status
    api_response = api_instance.get_status(x_v, x_min_v=x_min_v)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling CommonApi->get_status: %s\n" % e)
```
